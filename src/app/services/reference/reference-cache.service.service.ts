...
import { ReferenceInterface } from '../../interfaces/reference/reference.interface';
...
export class ReferenceCacheServiceService {
  ...
  private fetchCacheFromBackend(): Observable<ReferenceInterface[]> {
    return this.http.get<ReferenceInterface[]>(`/api/reference/all`).pipe(
      tap(data => {
